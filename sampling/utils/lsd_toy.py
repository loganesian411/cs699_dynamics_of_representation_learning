...
import LSD.toy_data as toy_data
import os
import matplotlib
matplotlib.use('Agg')
...
from LSD.utils import HMCSampler
...
class EBM(nn.Module):
    ...
    def load_state_dict(self, state_dict):
        self.base_mu = state_dict.pop('base_mu', None)
        self.base_logstd = state_dict.pop('base_logstd', None)
        super(EBM, self).load_state_dict(state_dict)
